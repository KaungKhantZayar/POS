            ...
            <div class="row">
              <div class="col-6 d-flex">
                ...
                <div class="col">
                  ...
                  <input type="text" class="form-control" placeholder="Date" disabled value="<?php echo "PR-" . rand(0,999999); ?>">
                  <input type="hidden" class="form-control" placeholder="Date" name="return_vr_no" value="<?php echo "PR-" . rand(0,999999); ?>">
                  <p style="color:red;"><?php echo empty($dateError) ? '' : '*'.$dateError;?></p>
                </div>
              </div>
