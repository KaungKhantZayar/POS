    ...
    <div class="col-md-12 px-3">
      <div class="d-flex mt-4 mb-4 justify-content-between">
        ...
        <div class="d-flex text-right">
          ...
          <div class="col">
            <a href="category_add.php" type="button" class="btn btn-purple text-light">Create New Category</a>
          </div>
        </div>
      </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="btn-group">
                  <div class="container">
                  <a href="category_edit.php?id=<?php echo $value['id'];?>" type="button" class="btn btn-sm">
                  ...
                  <div class="contaienr">
                  <a href="category_delete.php?id=<?php echo $value['id'];?>" type="button" class="btn btn-sm"  onclick="return confirm('Are you sure you want to Delete?');">
