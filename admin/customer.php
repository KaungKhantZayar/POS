    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Customer Listings</h3>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <div class="container">
                    <a href="customer_edit.php?id=<?php echo $value['id'];?>" type="button" class="btn btn-warning">
                    ...
                    <div class="contaienr">
                    <a href="customer_delete.php?id=<?php echo $value['id'];?>" type="button" class="btn btn-danger"  onclick="return confirm('Are you sure you want to Delete?');">
